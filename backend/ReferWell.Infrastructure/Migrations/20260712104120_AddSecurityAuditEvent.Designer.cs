...
namespace ReferWell.Infrastructure.Migrations
{
    ...
    [Migration("20260712104120_AddSecurityAuditEvent")]
    partial class AddSecurityAuditEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReferWell.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = "Male",
                            IsActive = true,
                            PasswordHash = "$2a$11$usTYFVLCvRJ3HAU9BKXmXODwJkaznYLmJM38iXyEKckBEMcqW/me6",
                        ...
                        new
                        {
                            ...
                            Gender = "Female",
                            IsActive = true,
                            PasswordHash = "$2a$11$7u7HqY5vymVyR5xdUz7keeAyOGdXapTe7wFekhG8.37aMZJKTZI2i",
                        ...
                        new
                        {
                            ...
                            Gender = "Male",
                            IsActive = true,
                            PasswordHash = "$2a$11$6runz5TB/JAAybqTEQQFteC8rnpiEwHBXe3Ot6rV5WqnoiJQPx0/O",
                        ...
                        new
                        {
                            ...
                            Gender = "Female",
                            IsActive = true,
                            PasswordHash = "$2a$11$4OMoErfcosnzo.paczoZeOS.R7YD9YvhfNTUWUlFUup4Pd6WD/WHG",
            ...
            modelBuilder.Entity("ReferWell.Domain.Entities.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 12, 22, 41, 20, 84, DateTimeKind.Local).AddTicks(5602),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 12, 22, 41, 20, 84, DateTimeKind.Local).AddTicks(5643),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 12, 22, 41, 20, 84, DateTimeKind.Local).AddTicks(5652),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 12, 22, 41, 20, 84, DateTimeKind.Local).AddTicks(5657),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 12, 22, 41, 20, 84, DateTimeKind.Local).AddTicks(5666),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 12, 22, 41, 20, 84, DateTimeKind.Local).AddTicks(5671),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 12, 22, 41, 20, 84, DateTimeKind.Local).AddTicks(5680),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 12, 22, 41, 20, 84, DateTimeKind.Local).AddTicks(5686),
            ...
            modelBuilder.Entity("ReferWell.Domain.Entities.Referral", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c256fcd5-9fda-439b-aa93-cefd25e57593"),
                        ...
                        new
                        {
                            Id = new Guid("ebae9fb7-cee1-442f-bcb6-727cf62d23bc"),
                            AssignedToUserId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CaseNo = "Ref-000002",
                        ...
                        new
                        {
                            Id = new Guid("939cb03d-b69f-4d27-b869-b7808f2fbcd1"),
                        ...
                        new
                        {
                            Id = new Guid("ba86d63f-133e-45b7-b6c6-1ba7c6a94be8"),
                            AssignedToUserId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CaseNo = "Ref-000004",
                        ...
                        new
                        {
                            Id = new Guid("75d4c217-7933-4913-b18e-075deb4bf5d7"),
                            AssignedToUserId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CaseNo = "Ref-000005",
                        ...
                        new
                        {
                            Id = new Guid("c621089a-dfb1-473d-ad09-3d398f8c4e36"),
                            AssignedToUserId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CaseNo = "Ref-000006",
                        ...
                        new
                        {
                            Id = new Guid("507b56b2-351f-491a-a16b-e8af3ab85fe5"),
                            AssignedToUserId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CaseNo = "Ref-000007",
                        ...
                        new
                        {
                            Id = new Guid("4506fdc9-7ed3-4457-be11-8f706a064526"),
                            AssignedToUserId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CaseNo = "Ref-000008",
